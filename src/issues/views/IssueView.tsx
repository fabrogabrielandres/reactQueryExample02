...
export const IssueView = () => {
  ...
  if(issueQuery.isLoading) return(<SpinLoader></SpinLoader>)
  ...
  return (
    <div className="row mb-5">
      ...
      {commentsQuery.isLoading && <SpinLoader/>  }      
      { commentsQuery.data?.map(comments=> <IssueComment key={comments.id} issue={ comments } />)}
